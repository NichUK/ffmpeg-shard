...
namespace FFmpegSharp
{
    public unsafe class MediaFileReader : IDisposable
    {
        ...
        public MediaFileReader(FileInfo File) : this(File.FullName) { }

        public MediaFileReader(FileStream File, CodecType codecType) : this(File.Name) { }
